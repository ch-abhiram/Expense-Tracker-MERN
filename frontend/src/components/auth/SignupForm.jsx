...
export default function SignupForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const success = await signup(inputs.name, inputs.email, inputs.password);
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-slate-700 space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Start your journey to financial freedom today. Create your account and begin 
              tracking your expenses, managing your budget, and reaching your financial goals.
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 bg-gray-50 focus:bg-white text-gray-900 placeholder:text-gray-400"
